...
/**
 * This is just like the Values component that the other examples import,
 * except that it works with Immutable JS.
 */
const ImmutableValues = ({ form }) => {
  ...
  const component = ({ values }) => {
    return (
      <div>
        <h2>Values</h2>
       { console.log(JSON.stringify(values ? values.toJS() : {}, null, 2))}
      </div>
    );
  };
